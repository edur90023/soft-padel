...
export const PublicBookingView: React.FC<PublicBookingViewProps> = ({ config, courts, bookings, onAddBooking }) => {
  ...
  return (
    <div className="h-full flex flex-col relative overflow-hidden font-sans bg-slate-950">
                     ...
                     <div className="space-y-12 relative z-10">
                        ...
                        <div className="space-y-8 py-10 border-y border-white/5">
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-slate-600 uppercase tracking-[0.4em] block">Fecha Seleccionada</label>
                            ...
                            {selectedSlotIds.length > 0 && (
                                <div className="space-y-2 animate-in slide-in-from-left-6">
                                    <label className="text-[10px] font-black text-slate-600 uppercase tracking-[0.4em] block">Tiempo de Juego</label>
                                    <div className="text-white font-black text-3xl flex items-center gap-4 bg-white/5 p-5 rounded-[1.5rem] border border-white/5 shadow-inner">
                            ...
                            {selectedCourtId && (
                                <div className="space-y-2 animate-in slide-in-from-left-6">
                                    <label className="text-[10px] font-black text-slate-600 uppercase tracking-[0.4em] block">Cancha Elegida</label>
                                    <div className="text-white font-black text-3xl flex items-center gap-4 bg-white/5 p-5 rounded-[1.5rem] border border-white/5 shadow-inner">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 mb-16">
                                    ...
                                    <div className="lg:col-span-4 grid grid-cols-1 gap-6">
                                        <div className="bg-white/5 p-10 rounded-[3rem] border border-white/5 flex items-center gap-6 group hover:bg-white/10 transition-all shadow-xl">
                                            ...
                                            <div><p className="text-white font-black text-2xl uppercase italic">Premium</p><p className="text-[10px] text-slate-500 font-bold uppercase mt-1">Sede Central</p></div>
                                        </div>
                                        <div className="bg-white/5 p-10 rounded-[3rem] border border-white/5 flex items-center gap-6 group hover:bg-white/10 transition-all shadow-xl">
